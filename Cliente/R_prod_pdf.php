...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(35, 10, 'Tamaño', 1, 0, 'C', true);
...
while ($row = mysqli_fetch_assoc($resultado)) {
    $pdf->cell(20, 10, $row['idprod'], 1, 0, 'C');    // ID del producto
    $pdf->cell(50, 10, $row['nombre'], 1, 0, 'C');    // Nombre del producto
    $pdf->cell(25, 10, $row['cantidad'], 1, 0, 'C');  // Cantidad
    $pdf->cell(30, 10, $row['precio'], 1, 0, 'C');    // Precio
    $pdf->cell(30, 10, $row['color'], 1, 0, 'C');     // Color
    $pdf->cell(35, 10, $row['tamanio'], 1, 0, 'C');   // Tamaño
